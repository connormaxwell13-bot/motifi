  ...
  <div style={{ margin: '0 auto' }}>
    ...
    <div style={{ paddingTop: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      <div style={{ display: 'flex', gap: '16px' }}>
        <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" style={{ color: '#4A6080', transition: 'color 0.15s ease' }} onMouseEnter={e => e.target.style.color='#00C896'} onMouseLeave={e => e.target.style.color='#4A6080'}>
